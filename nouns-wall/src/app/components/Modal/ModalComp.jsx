...
const ModalComp = ({setIsModalOpen}) => {
    ...
    console.log("radioooo",radiovalue)
    useEffect(() => {
  ...
  return (
       ...
       <div
          className={`fixed p-5 inset-y-48 z-[1055]  h-full w-full overflow-y-hidden overflow-x-hidden outline-none container`}
          id="exampleModalLg"
          ...
          <div className="pointer-events-auto relative flex w-full flex-col rounded-2xl border-2 border-[#4A5568] bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
            ...
            <div className="relative p-5">
              ...
              {/* <div className="pl-3">
                <label
                  for="pick_type"
                  className="block mb-2 font-medium text-[#1F1D28] text-base dark:text-white pt-4" >Pick type
                </label>
                <div className="flex">
                  <div className="flex items-center mr-16">
                    <div className="form-group block relative">
                        <input
                        type="checkbox" id="head"
                        className="form-checkbox h-5 w-5 text-green-500 checked:border-red checked hidden"
                        value="head"
                  ...
                  <div className="flex items-center mr-16">
                    <div className="form-group block relative">
                        <input
                        type="checkbox" id="accessory"
                        className="form-checkbox h-5 w-5 text-green-500  hidden"
